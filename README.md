...
You should take a look at the [wiki](https://github.com/nc0d3r/xmr-pool/wiki/Configuration-Details) for specific configuration settings in the system.
